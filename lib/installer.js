...
- \`npx mega-minds save-session "description"\` - Save progress after milestones  
- \`npx mega-minds agent-status\` - Check current agent coordination
- \`npx mega-minds setup-hooks\` - Configure Claude Code automation (optional)

### Documentation
- **Agent Templates**: \`.claude/agents/\` - All available specialist agents
- **Workflows**: \`.claude/workflows/\` - Communication protocols & quality gates
- **Rules**: Templates located in \`node_modules/mega-minds/templates/\`

---

💡 **Pro tip**: Always start with the @project-orchestrator-agent for best coordination between all specialist agents!

*Generated by Mega-Minds v2.1 with Variable-Driven Agent System*
`;
}
